    ...
    <div class="bg-[#EDEDED] py-10">
        <div class="bg-white rounded-lg mx-40">
            <div class="ml-20 flex py-20">
                <div class="mr-20">
                    <img class="w-[20vw] h-[70vh]" src="{{url('/images/HaiMiiko31.jpg')}}" alt="">
                </div>
                <div class="flex flex-col">
                    <h1 class="text-3xl font-semibold pb-6">Naruto Vol. 8</h1>
                    <h1 class="text-3xl font-bold pb-6">Rp.51.000</h1>
                    <h1 class="text-xl font-semibold">Book Description</h1>
                    <h1 class="text-lg pb-6">Lorem asdasdsadsaasdsaasd</h1>
                    <h1 class="text-xl font-semibold pb-2">Detail</h1>
                    <h1 class="text-base font-bold text-[#777777]">ISBN</h1>
                    <h1 class="text-base font-semibold pb-2 text-[#777777]">XXXXXX</h1>
                    <h1 class="text-base font-bold text-[#777777]">Penerbit</h1>
                    <h1 class="text-base font-semibold text-[#777777] pb-4">Lorem ipsum odor blablabla</h1>
                    ...
                    <div class="flex my-6">
                        ...
                        <div class="border rounded-md py-2 px-4 border-black w-40 text-center shadow-md" style="box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.5);">
                            <button class="text-xl font-bold">Wishlist</button>
                        </div>
                    </div>
                </div>
            </div>
